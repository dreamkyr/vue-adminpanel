    ...
    <div class="box box-primary">
      <div class="box-body box-profile">
        ...
        <div class="description">
          ...
          <p class="text-muted" v-if="userProfile.created_at">
            {{ userProfile.created_at | toDate }}
          </p>
        </div>
        <div class="description" v-if="userProfile.modified_by !== null || userProfile.modified_at">
          <div>
            <b>Modified by</b>
          ...
          <p class="text-muted" v-if="userProfile.modified_at">
            {{userProfile.modified_at | toDate }}
          </p>
        </div>
      </div>
      <!-- /.box-body -->
