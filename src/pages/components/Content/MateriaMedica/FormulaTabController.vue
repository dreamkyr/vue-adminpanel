<template>
    <div class="nav-tabs-custom">
      ...
      <FormulaSymptoms></FormulaSymptoms>
...
<script>
  ...
  const FormulaActions = () => import(/* webpackChunkName: "Modals" */ './../Modals/FormulaActions.vue')
  const FormulaSymptoms = () => import(/* webpackChunkName: "Modals" */ './../Modals/FormulaSymptoms.vue')
  ...
  export default {
    ...
    methods: {
      ...
      editFormula: function () {
        ...
        this.selectedFormula.modified_at = this.formula.modified_at
        ...
        this.selectedFormula.created_at = this.formula.created_at
