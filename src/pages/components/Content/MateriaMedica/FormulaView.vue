      ...
      <div class="row">
        <div class="col-md-3">
          <div class="box box-widget widget-user-2">
            ...
            <div class="box-body">
              <div class="description" v-if="formula.createdBy"><b>Created by</b> <a class="pull-right"><span class="badge bg-aqua">{{ formula.createdBy.firstname }} {{ formula.createdBy.lastname }}</span></a><p class="text-muted" data-toggle="tooltip" title="" data-original-title="Server Time">{{ formula.created_at | toDate }}</p></div>
              <hr>
              <div class="description" v-if="formula.modifiedBy"><b>Modified by</b> <a class="pull-right"><span class="badge bg-blue">{{ formula.modifiedBy.firstname }} {{ formula.modifiedBy.lastname }}</span></a><p class="text-muted" data-toggle="tooltip" title="" data-original-title="Server Time">{{ formula.modified_at | toDate }}</p></div>
            </div>
