    ...
    <section class="view-content-wrapper">
      <div class="row">
        ...
        <div class="col-md-9">
          ...
          <HerbCultivations></HerbCultivations>
          <HerbCautions></HerbCautions>
...
<script>
  ...
  const HerbSpecies = () => import(/* webpackChunkName: "Modals" */ './../Modals/HerbSpecies.vue')
  const HerbCultivations = () => import(/* webpackChunkName: "Modals" */ './../Modals/HerbCultivations.vue')
  const HerbCautions = () => import(/* webpackChunkName: "Modals" */ './../Modals/HerbCautions.vue')
