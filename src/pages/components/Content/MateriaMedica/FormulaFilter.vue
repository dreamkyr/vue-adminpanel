      ...
      <div class="box-body">
        ...
        <div class="form-group col-sm-12" style = "margin-top: 15px">
          ...
          <select class="form-control select2" multiple="multiple" data-placeholder="Select Authors" style="width: 100%;" v-model = "selected_author_list">
						<option v-for="author in author_list" :key='author.id' :value='author.id'>{{author.firstname}} {{author.lastname}}</option>
					</select>
          <!--
          <FBMultiSelect
            @select2="author_item = $event"
            :selectVal="author_item"
            :selectId="'authorSelect'"
            :defaultClass = "'col-sm-12'"
            :options="user_list">
            <label for="authorSelect" class="col-sm-12 control-label" slot="before">Author</label>
          </FBMultiSelect> -->
        </div>
        ...
        <div class="form-group">
          <FBSelect
            ...
            :defaultClass = "'col-sm-12'"
            :options="user_list">
            <label for="modifiedSelect" class="col-sm-12 control-label" style = "margin-top: 15px" slot="before">Modified</label>
          </FBSelect> 
        </div>
        <div class="form-group">
          <div class="input-group pull-left" style="width: 100%; margin-top: 15px; padding: 0 15px;">
            <button type="button" class="btn btn-default" v-on:click="openDataPicker" id="daterange-btn" style="width: 100%;">
              <span>
