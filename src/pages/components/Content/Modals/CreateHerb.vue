        ...
        <div class="modal-body">
          <form role="form">
            <div class="form-group">
                <label>Pinyin</label>
                <input type="text" class="form-control" placeholder="Enter pinyin name" v-model="herb.pinyin">
            </div>
            <div class="form-group">
                <label>Pinyin tones</label>
                <input type="text" class="form-control" placeholder="Enter Tones" v-model="herb.pinyin_ton">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="Enter Latin name" v-model="herb.latin_name">
            </div>
            <div class="form-group">
