<template>
  <div class="modal fade" id="modalHerbCategories" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
          <h4 class="modal-title" id="myModalLabel">Herbs Categories</h4>
        </div>
  ...
  export default {
    ...
    computed: {
      ...mapGetters({
        ...
        currentCategoriesIds: 'getHerbCategoryIds',
    ...
    created () {
      this.$store.dispatch('fetchHerbsCategories', {query: this.query})
    },
    watch: {
      ...
      modalType: {
        handler () {
          ...
          if (this.modalType === 0 && this.tabName === 'Category') {
            this.result = 'success'
            this.fetchHerbsCategories()
          }
        }
      }
    },
    methods: {
      fetchHerbsCategories: function () {
