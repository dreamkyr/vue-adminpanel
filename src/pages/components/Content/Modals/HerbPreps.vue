<template>
  <div class="modal fade" id="modalHerbPreps" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
          <h4 class="modal-title" id="myModalLabel">Herbs Preps</h4>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      editPrep: function (item) {
        ...
        this.prep.description = item.description
        ...
        this.prep.modified_by_name = item.modifiedBy.firstname + ' ' + item.modifiedBy.lastname
        this.prep.created_time = item.created_time
        this.prep.created_by_name = item.createdBy.firstname + ' ' + item.createdBy.lastname
