...
<script>
  ...
  export default {
    ...
    //         this.model.english_name = response.english_name
    //         this.model.traditional_chinese = response.traditional_chinese
    //         this.model.latin_name = response.latin_name
    //         this.model.simplified_chinese = response.simplified_chinese
    //         this.model.pinyin = response.pinyin
    //         this.model.pinyin_code = response.pinyin_code
    //       }
    //     }).catch((error) => {
    //       console.log(error)
    //     })
