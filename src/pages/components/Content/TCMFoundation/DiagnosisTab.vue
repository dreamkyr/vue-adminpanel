<template>
  <div class="">
    <div class="box-body">
      <h3>{{tabName}}&nbsp;
        <span data-toggle="tooltip" title="" class="badge bg-green" data-original-title="">10</span> 
        <button type="button" class="btn btn-success pull-right" data-toggle="modal" data-target="#modalGeneralCreate" @click="addCategory()"><i class="fa fa-plus"></i> Add New</button>
    ...
    <div class="table-responsive">
      <table class="table table-hover">
        ...
        <tr>
          ...
          <th v-if="type === 1">Description</th>
          <th v-if="type !== 2">Associated <i class="fa fa-caret-down"></i></th>
          <th></th>
        </tr>
        </thead>
        <tbody>
