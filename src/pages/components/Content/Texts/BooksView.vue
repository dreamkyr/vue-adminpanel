<template>
  ...
  <div class="box" id="books">
    <div class="box-body">
      ...
      <FBDataTable ref="tableBook" :css="css.table" :fields="fields" dataPath="items" :data="books"
        ...
        <template slot="control" slot-scope="props">
          <div class="btn-group pull-right">
            ...
            <button type="button" class="btn btn-sm btn-default" @click="deleteBook(props.rowData)"><i class="fa fa-trash"></i></button>
          </div>
        </template>
      ...
      <div slot="title">Delete {{selectedBook}}?</div>
      <div slot="body">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      deleteBook (item) {
        this.visible = true
        this.selectedBook = item.english_name
      ...
      confirmDelete () {
        ...
        this.$store.dispatch('deleteBook', this.selectedId)
          .then((response) => {
            this.$store.dispatch('setLoadingBar', 'none')
            this.$refs.tableBook.reload()
          })
