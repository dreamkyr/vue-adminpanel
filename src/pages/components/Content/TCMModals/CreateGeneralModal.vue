    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel" v-if = "this.modalType === 1">New {{tabName}}</h4>
            ...
            <div class = "row">
              ...
              <div class="col-sm-6" v-if = "type === 2">
                ...
                <div class="row" v-for ="index_row in rowLength" :key="index_row">
                  <div class = "color-picker" v-for = "index_col in 9" v-bind:style="{background:colorList[(index_row - 1) * 9 + index_col - 1]} " :key="index_col" @click="setColor(index_row - 1, index_col)"></div>
                </div>
                <div class = "row">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-lg btn-success" @click="save()" v-if = "this.modalType === 1" :disabled="general.name === '' || general.traditional_chinese === '' || general.simplified_chinese === '' || category_item === ''">Create</button>
  ...
  export default {
    ...
    computed: {
      ...mapGetters({
        ...
        type: 'getTcmTabType',
        categories: 'getDefinedCategories',
    ...
    watch: {
      modalType: {
        handler () {
          ...
          this.general.categories = this.selectedGeneral.categories
    ...
    methods: {
      ...
      update: function () {
        ...
        if (category.id && category.id !== '') this.general.categories.push(category)
